...
const inputs1 = ref<FormInputItem[]>([
  // ==========================================
...
const inputs = ref<FormInputItem[]>([
  ...
  },
  {
    name: 'last_name',
    type: 'input',
    label: 'Last Name (Optional but Validated)',
...
//     outlined: true,
//     accept: '.pdf,.png,.jpg,.jpeg',
//     rules: 'required|maxFileSize:2MB|allowedExt:.pdf,.png,.jpg,.jpeg',
//     col: 'col-12'
//   },
//
// // ==========================================
